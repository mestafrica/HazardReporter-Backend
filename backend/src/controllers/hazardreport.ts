...
const createHazardReport = async (req: RequestWithFiles, res: Response, next: NextFunction) => {
    try {
...
const getHazardReportById = async (req: Request, res: Response, next: NextFunction) => {
    ...
    try {
        ...
        if (hazardreport) {
            return res.status(200).json({ message: "Hazard Report found", hazardreport });
        } else {
...
const updateHazardReport = async (req: Request, res: Response, next: NextFunction) => {
    ...
    try {
        ...
        const timeDifference = Date.now() - new Date(hazardReport.createdAt).getTime();
        ...
        return res.status(200).json({ message: "Hazard Report updated successfully", hazardReport });
    } catch (error) {
...
const getHazardReportStats = async (req: Request, res: Response, next: NextFunction) => {
    try {
